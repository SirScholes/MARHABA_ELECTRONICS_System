...
define('DB_NAME', 'marhabaelectronics_db');
...
define('SITE_NAME', 'Marhaba Electronics');
define('SITE_URL', 'http://localhost/Marhabaelectronics/'); // Make sure this matches your folder path
